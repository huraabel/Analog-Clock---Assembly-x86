...
TO_MSECOND_QUIT:JMP       MSECOND_QUIT
MSECOND_LIN_NEXT:           
                         
              MOV       SIGLE,80H
              MOV       MSECOND2,DH 
              MOV       COLOR,0          
              MOV       AL,MSECOND             ;ERASE  (NCHANGE: DL TO AL)
              MOV       AH,0
              MOV       CL,6
              MUL       CL
              MOV       BX,R0
              ...
              MOV       COLOR,AL
              MOV       AL,MSECOND2				; (NCHANGE: FORM DL TO AL)
              MOV       AH,0
              MOV       CL,6
              MUL       CL
			  ...
			  CMP		DL, 56
			  JB		SECOND_SKIP
              CALL      SECOND_LIN				; (NCHANGE: MINUTE_LIN)
			  ;PUSH		CX
			  ;MOV		CL, SECOND
			  ;CMP		MSECOND2, CL
			  ;JNE		S_SKIP_2
